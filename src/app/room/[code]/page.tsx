...
export default function RoomPage() {
  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-zinc-100 pb-96 p-4 sm:p-8 max-w-6xl mx-auto flex flex-col gap-6 font-sans">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-zinc-950/60 rounded-2xl border border-zinc-800/80 overflow-hidden space-y-3 p-5">
              {room?.bunker_info?.catastrophe && (
                <CatastropheImage title={room.bunker_info.catastrophe} roomCode={room.code || room.id} />
              )}
              <div>
      ...
      {/* 4. СТАРТОВЫЙ ОВЕРЛЕЙ КАТАСТРОФЫ И ЦЕЛИ */}
      ...
      {/* 5. ОВЕРЛЕЙ РАСКРЫТОЙ КОМНАТЫ БУНКЕРА */}
      {roomRevealOverlay && (
